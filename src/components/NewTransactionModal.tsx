...
import { Transaction, transactionSchema, Chapter } from "~/common/types";
...
export const NewTransactionModal = ({
  ...
  const handleChapterChange = (chapter: string) => setChapter(chapter);
          ...
          >
            <HStack align="start" spacing="55px">
              ...
              <FormControl>
                ...
                <RadioDropdown
                  options={[
                    ...(chapters.data?.map((ch: Chapter) => ch.name) ?? []),
                    "Unclassified",
                  ]}
