...
const developmentLogger = new AnalyticsLogger({
  environment: EventEnvironment.DEVELOPMENT,
});
const stagingLogger = new AnalyticsLogger({
  environment: EventEnvironment.STAGING,
});
const productionLogger = new AnalyticsLogger({
...
export async function logUserLoginEvent() {
  ...
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.USER_LOGIN.category,
    CustomEventTypes.USER_LOGIN.subcategory,
    {},
  );
}
...
export async function logEventCreationEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.EVENT_CREATION.category,
    CustomEventTypes.EVENT_CREATION.subcategory,
    {
      name,
    },
  );
...
export async function logEventEditEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.EVENT_EDIT.category,
    CustomEventTypes.EVENT_EDIT.subcategory,
    {
      name,
    },
  );
...
export async function logEventDeleteEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.EVENT_DELETE.category,
    CustomEventTypes.EVENT_DELETE.subcategory,
    {
      name,
    },
  );
...
export async function logExpenseCreationEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.EXPENSE_CREATION.category,
    CustomEventTypes.EXPENSE_CREATION.subcategory,
    {
      name,
    },
  );
...
export async function logExpenseEditEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.EXPENSE_EDIT.category,
    CustomEventTypes.EXPENSE_EDIT.subcategory,
    {
      name,
    },
  );
...
export async function logExpenseDeleteEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.EXPENSE_DELETE.category,
    CustomEventTypes.EXPENSE_DELETE.subcategory,
    {
      name,
    },
  );
...
export async function logFundraiserCreationEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.FUNDRAISER_CREATION.category,
    CustomEventTypes.FUNDRAISER_CREATION.subcategory,
    {
      name,
    },
  );
...
export async function logFundraiserEditEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.FUNDRAISER_EDIT.category,
    CustomEventTypes.FUNDRAISER_EDIT.subcategory,
    {
      name,
    },
  );
...
export async function logFundraiserDeleteEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.FUNDRAISER_DELETE.category,
    CustomEventTypes.FUNDRAISER_DELETE.subcategory,
    {
      name,
    },
  );
...
export async function logDonorCreationEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.DONOR_CREATION.category,
    CustomEventTypes.DONOR_CREATION.subcategory,
    {
      name,
    },
  );
...
export async function logDonorEditEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.DONOR_EDIT.category,
    CustomEventTypes.DONOR_EDIT.subcategory,
    {
      name,
    },
  );
...
export async function logDonorDeleteEvent(name: string) {
  const analyticsLogger = getAnalyticsLogger();
  await analyticsLogger.logCustomEvent(
    CustomEventTypes.DONOR_DELETE.category,
    CustomEventTypes.DONOR_DELETE.subcategory,
    {
      name,
    },
  );
